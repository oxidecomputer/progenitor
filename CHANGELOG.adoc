...
https://github.com/oxidecomputer/progenitor/compare/v0.15.0\...HEAD[Full list of commits]

== 0.15.0 (released 2026-09-10)

https://github.com/oxidecomputer/progenitor/compare/v0.14.0\...v0.15.0[Full list of commits]

* Update typify to 0.8.0 (#1369) (#1423)
* Make the request mutable in the sync pre_hook (#825)
* Stop activating schemars chrono/uuid1 features in progenitor (#1363)
* CLI generation: merge summary and description into a single about (#1380)

* Generate a response enum for an operation whose successes, or whose errors, carry more than one type, instead of panicking
