...
https://github.com/oxidecomputer/progenitor/compare/v0.4.1\...HEAD[Full list of commits]

== 0.4.1 (released 2023-12-15)

https://github.com/oxidecomputer/progenitor/compare/v0.4.1\...v0.4.1[Full list of commits]
